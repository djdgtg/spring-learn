...
(function ($) {
  ...
  $.fn.extend({
    tableExport: function (options) {
      ...
      var myDate = new Date();    
      var exportfileName = myDate.toLocaleDateString();
      
      var secondMenuVal = $("#secondMenuVal").text();
      if(secondMenuVal!= undefined){
    	  exportfileName =  secondMenuVal+ myDate.toLocaleDateString();
      }else{
    	  exportfileName +='-导出';
